...
Apply the concern lens @.agents/workflows/assess/lenses/accessibility.md on top of that harness: it selects the concern, its lead personas, and its rubric. Assess that single concern deeply and write an IPD into the project's pending-plans directory; do not change code and do not execute the plan.
